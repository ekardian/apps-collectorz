...
<!--To local cover-->
         <!--<a href="../images/{$in_id}{$in_postfix}.{$extf}"><img src="../images/{$in_id}{$in_postfix}.{$extf}" height="200"/></a>-->
<!--End to local cover-->
          <img src="https://googledrive.com/host/folderview?id=0B4IL_NIjd8oWfmkwYmZwS3RrSUg5VWY4T2RfQW1JZnFJWTY5alFfN3lXSjdqYkJlRWVwbFE/{$in_id}{$in_postfix}.{$extf}" height="200"/>
<!--To web cover-->
...
<table class="titletable opacity" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top"><div id="topbar"><xsl:call-template name="maintitle"/></div>
			...
			<p /><xsl:if test="collectionstatus !=''">
    ...
    <div class="navigationline">
      <xsl:choose>
        <xsl:when test="firstlink/@url!=''">
          <div class="navlink" id="first"><a href="{firstlink/@url}"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttFirst']/@label"/></a></div>
        </xsl:when>
        <xsl:otherwise>
          <div class="navlink" id="first"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttFirst']/@label"/></div>
        </xsl:otherwise>
      </xsl:choose>   
      <xsl:choose>
        <xsl:when test="prevlink/@url!=''">
          <div class="navlink" id="prev"><a href="{prevlink/@url}"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttPrev']/@label"/></a></div>
        </xsl:when>
        <xsl:otherwise>
          <div class="navlink" id="prev"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttPrev']/@label"/></div>
        </xsl:otherwise>
      </xsl:choose>   
      <xsl:choose>
        <xsl:when test="uplink/@url!=''">
          <div class="navlink" id="up"><a href="{uplink/@url}"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttUp']/@label"/></a></div>
        </xsl:when>
        <xsl:otherwise>
          <div class="navlink" id="up"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttUp']/@label"/></div>
        </xsl:otherwise>
      </xsl:choose>   
      <xsl:choose>
        <xsl:when test="nextlink/@url!=''">
          <div class="navlink" id="next"><a href="{nextlink/@url}"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttNext']/@label"/></a></div>
        </xsl:when>
        <xsl:otherwise>
          <div class="navlink" id="next"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttNext']/@label"/></div>
        </xsl:otherwise>
      </xsl:choose>   
      <xsl:choose>
        <xsl:when test="lastlink/@url!=''">
          <div class="navlink" id="last"><a href="{lastlink/@url}"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttLast']/@label"/></a></div>
        </xsl:when>
        <xsl:otherwise>
          <div class="navlink" id="last"><xsl:value-of select="/musicinfo/localizedtemplatetexts/field[@id='ttLast']/@label"/></div>
        </xsl:otherwise>
      </xsl:choose>   
    </div>
  </div>
